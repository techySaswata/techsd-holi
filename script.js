...
// Block access for mobile Chrome (non-web view)
(function() {
  var userAgent = navigator.userAgent || navigator.vendor || window.opera;
  // Detect mobile Chrome: contains "Chrome" and "Android" but not "wv" or "Version/"
  var isMobileChrome = /Chrome/.test(userAgent) && /Android/.test(userAgent) && !/wv/.test(userAgent) && !/Version\/\d+/.test(userAgent);
  if (isMobileChrome) {
    document.body.innerHTML = "<h2 style='text-align:center;margin-top:20%;'>This website is not accessible on mobile Chrome. Please use a desktop browser or open within an app.</h2>";
    throw new Error("Mobile Chrome access blocked.");
  }
})();
